...
CREATE TABLE `metodo_pagos` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `metodo_pagos_numerotarjeta_unique` (`numeroTarjeta`),
  KEY `metodo_pagos_usuario_id_foreign` (`usuario_id`),
  CONSTRAINT `metodo_pagos_usuario_id_foreign` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
